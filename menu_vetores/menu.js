...
import {
    ...
    filtrarVetor,
    ehPositivo, ehNegativo, ehNulo, ehPar, ehImpar,
    reduzirVetor,
    somatorio,
    mediaVetor, medianaVetor,
    sortearElemento,
    gerarN_Grupos,
    ...
    valorMedioNoVetor,
    eh_MaiorQue_A_Media, eh_Menor_Que_A_Media,
...
function main() {
    ...
    while (opcao !== 0) {
        if (opcao === 1) {
            ...
            if (verificarSeVetorEstaContidoEmOutro(vetor, novo_vetor) && verificarSeElementosEstaoNaMesmaOrdem(vetor, novo_vetor)) {
            ...
            const media = mediaVetor(vetor)
            const maiores_que_a_media = filtrarVetor(vetor, eh_MaiorQue_A_Media(media))
            const menores_que_a_media = filtrarVetor(vetor, eh_Menor_Que_A_Media(media))
            ...
            if (opcao_ordenar === 1) {
                ...
                mostrarVetor(vetor_ordenado, "Vetor ordenado em ordem crescente: ")
            }
                ...
                mostrarVetor(vetor_ordenado, "Vetor de pares ordenado em ordem crescente: ")
            }
                ...
                mostrarVetor(vetor_ordenado, "Vetor de ímpares ordenado em ordem crescente: ")
            }
                ...
                mostrarVetor(vetor_ordenado, "Vetor de positivos ordenado em ordem crescente: ")
            }
                ...
                mostrarVetor(vetor_ordenado, "Vetor de negativos ordenado em ordem crescente: ")
            }
                ...
                mostrarVetor(vetor_ordenado, `Vetor de múltiplos de ${n} ordenado em ordem crescente: `)
            }
            ...
            if (opcao_ordenar === 1) {
                ...
                mostrarVetor(vetor_ordenado, "Vetor de pares ordenado em ordem decrescente: ")
            }
            else if (opcao_ordenar === 3) {
                const vetor_impares = filtrarVetor(vetor, ehImpar)
                mostrarVetor(vetor_impares, "Vetor de ímpares: ")
                vetor_ordenado = ordenar_Vetor_Decrescente(vetor_impares)
                mostrarVetor(vetor_ordenado, "Vetor de ímpares ordenado em ordem decrescente: ")
            }
            else if (opcao_ordenar === 4) {
                const vetor_positivos = filtrarVetor(vetor, ehPositivo)
                mostrarVetor(vetor_positivos, "Vetor de positivos: ")
                vetor_ordenado = ordenar_Vetor_Decrescente(vetor_positivos)
                mostrarVetor(vetor_ordenado, "Vetor de positivos ordenado em ordem decrescente: ")
            }
            else if (opcao_ordenar === 5) {
                const vetor_negativos = filtrarVetor(vetor, ehNegativo)
                mostrarVetor(vetor_negativos, "Vetor de negativos: ")
                vetor_ordenado = ordenar_Vetor_Decrescente(vetor_negativos)
                mostrarVetor(vetor_ordenado, "Vetor de negativos ordenado em ordem decrescente: ")
            }
            else if (opcao_ordenar === 6) {
                ...
                mostrarVetor(vetor_ordenado, `Vetor de múltiplos de ${n} ordenado em ordem decrescente: `)
            }
...
function menu() {
    ...
    if (pergunta === "s") {
        ...
        console.log("15 - Listar valor médio, e listar números maiores que a média\n e menores que a média")
        console.log("16 - Somatório da média dos números positivos múltiplos de 2 com o \nproduto acumulado dos números negativos pares reduzidos pela metade")
